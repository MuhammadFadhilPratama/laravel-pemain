    ...
    <div class="card-body">
        <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Edit Pemain</h3>
            </div>
            <form method="POST" action="/dashboard/pemain/{{ $pemain->id }}">
            @method('put')
            @csrf
            <div class="card-body">
                <div class="form-grup">
                    ...
                    id="nama_pemain" name="nama_pemain" placeholder="Nama Pemain" value="{{ old('nama_pemain',$pemain->nama_pemain) }}">
                    @error('nama_pemain')
            ...
            <div class="form-grup mt-3">
                ...
                id="asal_pemain" name="asal_pemain" placeholder="Asal Pemain"value="{{ old('asal_pemain',$pemain->asal_pemain) }}">
                @error('asal_pemain')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-grup mt-3">
                    ...
                    id="ket_pemain" name="ket_pemain" placeholder="Ket Pemain"value="{{ old('ket_pemain',$pemain->ket_pemain) }}">
                    @error('ket_pemain')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
